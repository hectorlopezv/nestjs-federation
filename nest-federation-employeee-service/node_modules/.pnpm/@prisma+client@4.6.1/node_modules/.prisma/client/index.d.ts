  ...
  */
  ...
  export type ProjectGetPayload<S extends boolean | null | undefined | ProjectArgs, U = keyof S> =
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'employees' ? Array < EmployeeGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    : S extends { select: any } & (ProjectArgs | ProjectFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'employees' ? Array < EmployeeGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export type EmployeeGetPayload<S extends boolean | null | undefined | EmployeeArgs, U = keyof S> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    : S extends { select: any } & (EmployeeArgs | EmployeeFindManyArgs)
      ? {
    [P in TrueKeys<S['select']>]:
        P extends 'project' ? ProjectGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Employee ? Employee[P] : never
  } 
      : Employee
  ...
  export type EmployeeUpdateInput = {
    ...
    project?: ProjectUpdateOneRequiredWithoutEmployeesNestedInput
  }
  ...
  export type EmployeeCreateNestedManyWithoutProjectInput = {
    create?: XOR<Enumerable<EmployeeCreateWithoutProjectInput>, Enumerable<EmployeeUncheckedCreateWithoutProjectInput>>
    connectOrCreate?: Enumerable<EmployeeCreateOrConnectWithoutProjectInput>
  ...
  export type EmployeeUpdateManyWithoutProjectNestedInput = {
    create?: XOR<Enumerable<EmployeeCreateWithoutProjectInput>, Enumerable<EmployeeUncheckedCreateWithoutProjectInput>>
    connectOrCreate?: Enumerable<EmployeeCreateOrConnectWithoutProjectInput>
    upsert?: Enumerable<EmployeeUpsertWithWhereUniqueWithoutProjectInput>
    ...
    connect?: Enumerable<EmployeeWhereUniqueInput>
    update?: Enumerable<EmployeeUpdateWithWhereUniqueWithoutProjectInput>
    updateMany?: Enumerable<EmployeeUpdateManyWithWhereWithoutProjectInput>
